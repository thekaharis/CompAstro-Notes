...
Both feed the same design question as [[Spectral Mode Cutoff in FNOs]]: what the operator can *represent* has turned out to matter less, for sharp ionization fronts, than what the objective *selects for* — see [[Hedging Bias of Pointwise Losses]].
